 ...
 * getThrottledFn(); // => []
 */const getThrottledFn=(func,delay=1000)=>{ow(func,ow.function);ow(delay,ow.optional.number.not.infinite);let timeout=null;return(...args)=>{if(!timeout){func(...args);timeout=setTimeout((()=>{timeout=null}),delay)}}};export{getThrottledFn};
