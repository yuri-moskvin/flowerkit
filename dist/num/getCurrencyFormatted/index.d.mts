 ...
 * });
 */
export declare const getCurrencyFormatted: (num: number, currency: string, locales?: Intl.LocalesArgument, options?: Omit<Intl.NumberFormatOptions, "style" | "currency">) => string;
