Object.defineProperty(exports,"__esModule",{value:true});var ssrWindow=require("ssr-window");var index=require("../../evt/bubble/index.cjs");var index$2=require("../../obj/getObjFromFormData/index.cjs");var index$1=require("../getFormDataFromObj/index.cjs");var index$3=require("../getUrlWithQueryParams/index.cjs");
/**
...
/**
   ...
   * @private
   */const getUrl=()=>{const methodsNoBody=["GET","HEAD","CONNECT","OPTIONS","TRACE"];return methodsNoBody.includes(method)&&data!==null?index$3.getUrlWithQueryParams(url,isFormData(data)?data:data):url};
/**
   * Response parser
   * @private
