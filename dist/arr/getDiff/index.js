 ...
 */const getDiff=(arr1,arr2)=>{ow(arr1,ow.array);ow(arr2,ow.array);return arr1.concat(arr2).filter(((val,index,arr)=>arr.indexOf(val)===arr.lastIndexOf(val)))};export{getDiff};
