 ...
 */const isMediaQuery=str=>{if(typeof str!=="string")throw new TypeError("isMediaQuery: str must be a string");const query=str.startsWith("(")&&str.endsWith(")")?str:`(${str})`;return getWindow().matchMedia(query)?.matches??false};export{isMediaQuery};
